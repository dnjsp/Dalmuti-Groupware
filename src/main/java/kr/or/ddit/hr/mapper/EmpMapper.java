...
public interface EmpMapper {
	// 재직자 직원 목록
	List<Map<String, Object>> selectIng(Map<String, Object> map);
	// 재직자 수
	int selectIngCount();
	
	// 퇴직자 직원 목록
	List<Map<String, Object>> selectRetire(Map<String, Object> map);
	// 퇴직자 수
	int selectRetireCount();
	
	// 직원 검색
	List<Map<String, Object>> searchEmp(Map<String, Object> map);
	// 직원 검색 결과 수
	int searchEmpCount(String keyword);
	
	// 부서로 직원 목록
	List<Map<String, Object>> selectByDept(Map<String, Object> map);
	// 부서 구분 결과 수
	int selectByDeptCount(Map<String, Object> map);
	...
	// 기본 권한 부여
	int insertAuthor(Map<String, Object> map);
	
	// 직원 상세 정보
	EmpVO detailEmp(String empNo);
	
	// 해당직원 부서 가져오기
	DeptVO selectDept(String empNo);
	
	// 직원 정보 수정
	int updateEmp(EmpVO emp);
	
	// 퇴사 처리
	int retireEmp(EmpVO emp);
	
	// 조직도 - 부서
	List<Map<String, Object>> deptList(Map<String, Object> map);

	// 조직도 - 팀
	List<Map<String, Object>> teamList(Map<String, Object> map);

	// 조직도 - 부서(직원)
	List<Map<String, Object>> deptEmpList(Map<String, Object> map);
	
	// 조직도 - 직원 상세정보
	EmpVO empDetail(String empNo);
