...
!function(e, t) {
    ...
    w.extend({
        ...
        makeArray: function(e, t) {
            var n = t || [];
            return null != e && (_(Object(e)) ? w.merge(n, "string" == typeof e ? [e] : e) : a.call(n, e)),
            n
        },
    ...
    var k = function(e) {
        var t, n, i, o, r, a, s, l, c, u, p, f, h, d, g, m, y, v, b, x = "sizzle" + 1 * new Date, w = e.document, _ = 0, k = 0, E = le(), T = le(), S = le(), C = le(), A = function(e, t) {
            return e === t && (p = !0),
            0
            ...
            for (var n = 0, i = e.length; n < i; n++)
                if (e[n] === t)
                    return n;
            return -1
        }, P = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", R = "[\\x20\\t\\r\\n\\f]", H = "(?:\\\\[\\da-fA-F]{1,6}" + R + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", q = "\\[" + R + "*(" + H + ")(?:" + R + "*([*^$|!~]?=)" + R + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + H + "))|)" + R + "*\\]", F = ":(" + H + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + q + ")*)|.*)\\)|)", W = new RegExp(R + "+","g"), z = new RegExp("^" + R + "+|((?:^|[^\\\\])(?:\\\\.)*)" + R + "+$","g"), U = new RegExp("^" + R + "*," + R + "*"), B = new RegExp("^" + R + "*([>+~]|" + R + ")" + R + "*"), X = new RegExp(R + "|>"), Y = new RegExp(F), V = new RegExp("^" + H + "$"), $ = {
            ID: new RegExp("^#(" + H + ")"),
            CLASS: new RegExp("^\\.(" + H + ")"),
            TAG: new RegExp("^(" + H + "|[*])"),
            ATTR: new RegExp("^" + q),
        ...
        }, Q = /HTML$/i, K = /^(?:input|select|textarea|button)$/i, G = /^h\d$/i, J = /^[^{]+\{\s*\[native \w/, Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ee = /[+~]/, te = new RegExp("\\\\[\\da-fA-F]{1,6}" + R + "?|\\\\([^\\r\\n\\f])","g"), ne = function(e, t) {
        ...
        try {
            j.apply(O = D.call(w.childNodes), w.childNodes),
        ...
        function se(e, t, i, o) {
            var r, s, c, u, p, d, y, v = t && t.ownerDocument, w = t ? t.nodeType : 9;
            if (i = i || [],
            ...
            g)) {
                ...
                if (n.qsa && !C[e + " "] && (!m || !m.test(e)) && (1 !== w || "object" !== t.nodeName.toLowerCase())) {
                    ...
                    try {
                        return j.apply(i, v.querySelectorAll(y)),
                        i
                    } catch (t) {
                        C(e, !0)
                    } finally {
        ...
        f = se.setDocument = function(e) {
            ...
            : function(e, t) {
                ...
                if (!o || !r)
                    return e == h ? -1 : t == h ? 1 : o ? -1 : r ? 1 : u ? I(u, e) - I(u, t) : 0;
                if (o === r)
                    return fe(e, t);
        ...
        (i = se.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(e) {
                    var t, n = !e[6] && e[2];
                    return $.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && Y.test(n) && (t = a(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t),
                    e[2] = n.slice(0, t)),
                    e.slice(0, 3))
                }
            },
            filter: {
                ...
                CHILD: function(e, t, n, i, o) {
                    ...
                    : function(t, n, l) {
                        var c, u, p, f, h, d, g = r !== a ? "nextSibling" : "previousSibling", m = t.parentNode, y = s && t.nodeName.toLowerCase(), v = !l && !s, b = !1;
                        if (m) {
                            if (r) {
                                for (; g; ) {
                                    for (f = t; f = f[g]; )
                            ...
                            a && v) {
                                for (b = (h = (c = (u = (p = (f = m)[x] || (f[x] = {}))[f.uniqueID] || (p[f.uniqueID] = {}))[e] || [])[0] === _ && c[1]) && c[2],
                                f = h && m.childNodes[h]; f = ++h && f && f[g] || (b = h = 0) || d.pop(); )
                                    if (1 === f.nodeType && ++b && f === t) {
                                        u[e] = [_, h, b];
                                        break
                                    }
                            } else if (v && (b = h = (c = (u = (p = (f = t)[x] || (f[x] = {}))[f.uniqueID] || (p[f.uniqueID] = {}))[e] || [])[0] === _ && c[1]),
                            !1 === b)
                                for (; (f = ++h && f && f[g] || (b = h = 0) || d.pop()) && ((s ? f.nodeName.toLowerCase() !== y : 1 !== f.nodeType) || !++b || (v && ((u = (p = f[x] || (f[x] = {}))[f.uniqueID] || (p[f.uniqueID] = {}))[e] = [_, b]),
                                f !== t)); )
                                    ;
            ...
            ce((function(r, a, s, l) {
                var c, u, p, f = [], h = [], d = a.length, g = r || function(e, t, n) {
                    for (var i = 0, o = t.length; i < o; i++)
                        se(e, t[i], n);
                    return n
                }(t || "*", s.nodeType ? [s] : s, []), m = !e || !r && t ? g : _e(g, f, e, s, l), y = n ? o || (r ? e : d || i) ? [] : a : m;
                if (n && n(m, y, s, l),
                i)
                    for (c = _e(y, h),
                    i(c, [], s, l),
                ...
                if (r) {
                    ...
                    y = _e(y === a ? y.splice(d, y.length) : y),
        ...
        a = se.tokenize = function(e, t) {
            ...
            c = i.preFilter; s; ) {
                ...
                s = s.slice(n.length)),
                i.filter)
                    !(o = $[a].exec(s)) || c[a] && !(o = c[a](o)) || (n = o.shift(),
                    r.push({
                        value: n,
                        type: a,
                        matches: o
            ...
            if (!m) {
                ...
                u = function(e, t, n, a, u) {
                    ...
                    s && v !== y) {
                        ...
                        j.apply(a, x),
                        u && !e && 0 < x.length && 1 < y + r.length && se.uniqueSort(a)
                    }
                    return u && (_ = E,
                    c = w),
                    b
        ...
        l = se.select = function(e, t, n, o) {
            ...
            return (f || s(e, h))(o, t, !g, n, !t || ee.test(e) && ye(t.parentNode) || t),
            n
        }
        ,
    ...
    w.each({
        ...
        w.fn[e] = function(n, i) {
            ...
            1 < this.length && (j[e] || w.uniqueSort(o),
            M.test(e) && o.reverse()),
            this.pushStack(o)
        }
    }
    ...
    w.extend({
                            ...
                            var s = this
                              ...
                              , c = function() {
                                ...
                                if (!(t < r)) {
                                    ...
                                    d(c) ? o ? c.call(e, a(r, n, P, o), a(r, n, R, o)) : (r++,
                                    c.call(e, a(r, n, P, o), a(r, n, R, o), a(r, n, P, n.notifyWith))) : (i !== P && (s = void 0,
                                    l = [e]),
                                    (o || n.resolveWith)(s, l))
                                }
                            }
        ...
        when: function(e) {
            ...
            "pending" === a.state() || d(r[n] && r[n].then)))
                return a.then();
            for (; n--; )
                H(r[n], s(n), a.reject);
            return a.promise()
    ...
    function ce(e, t) {
        for (var n, i, o, r, a, s, l, c = [], u = 0, p = e.length; u < p; u++)
            ...
            t ? ("none" === n && (c[u] = Q.get(i, "display") || null,
            c[u] || (i.style.display = "")),
    ...
    w.event = {
        ...
        remove: function(e, t, n, i, o) {
            ...
            if (m && (l = m.events)) {
                for (c = (t = (t || "").match(I) || [""]).length; c--; )
                    if (h = g = (s = xe.exec(t[c]) || [])[1],
                    d = (s[2] || "").split(".").sort(),
                    h) {
                        for (p = w.event.special[h] || {},
                        f = l[h = (i ? p.delegateType : p.bindType) || h] || [],
                        s = s[2] && new RegExp("(^|\\.)" + d.join("\\.(?:.*\\.|)") + "(\\.|$)"),
                        a = r = f.length; r--; )
                            u = f[r],
                            !o && g !== u.origType || n && n.guid !== u.guid || s && !s.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (f.splice(r, 1),
                            u.selector && f.delegateCount--,
                            p.remove && p.remove.call(e, u));
                        a && !f.length && (p.teardown && !1 !== p.teardown.call(e, d, m.handle) || w.removeEvent(e, h, m.handle),
                        delete l[h])
                    } else
                        for (h in l)
        ...
        dispatch: function(e) {
            var t, n, i, o, r, a, s = new Array(arguments.length), l = w.event.fix(e), c = (Q.get(this, "events") || Object.create(null))[l.type] || [], u = w.event.special[l.type] || {};
            for (s[0] = l,
        ...
        special: {
            ...
            click: {
                setup: function(e) {
                    var t = this || e;
                    return fe.test(t.type) && t.click && C(t, "input") && Te(t, "click", we),
                    !1
                },
                trigger: function(e) {
                    var t = this || e;
    ...
    function je(e, t, n, i) {
        t = r(t);
        var o, a, s, l, c, u, p = 0, f = e.length, g = f - 1, m = t[0], y = d(m);
        ...
        a || i)) {
            ...
            if (l)
                ...
                p = 0; p < l; p++)
                    c = s[p],
                    de.test(c.type || "") && !Q.access(c, "globalEval") && w.contains(u, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? w._evalUrl && !c.noModule && w._evalUrl(c.src, {
        ...
        clone: function(e, t, n) {
            ...
            if (!(h.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || w.isXMLDoc(e)))
                ...
                o = (r = me(e)).length; i < o; i++)
                    s = r[i],
                    "input" === (c = (l = a[i]).nodeName.toLowerCase()) && fe.test(s.type) ? l.checked = s.checked : "input" !== c && "textarea" !== c || (l.defaultValue = s.defaultValue);
            if (t)
                if (n)
                    for (r = r || me(e),
                    a = a || me(u),
                    ...
                    Me(e, u);
            return 0 < (a = me(u, "script")).length && ye(a, !p && me(e, "script")),
            u
        },
    ...
    function qe(e, t, n) {
        ...
        return (n = n || Pe(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || oe(e) || (a = w.style(e, t)),
        !h.pixelBoxStyles() && Ie.test(a) && He.test(t) && (i = s.width,
        o = s.minWidth,
        r = s.maxWidth,
    ...
    !function() {
        ...
        var i, o, r, a, s, l, c = m.createElement("div"), u = m.createElement("div");
    ...
    function Ge(e, t, n) {
        ...
        return (!h.boxSizingReliable() && o || !h.reliableTrDimensions() && C(e, "tr") || "auto" === a || !parseFloat(a) && "inline" === w.css(e, "display", !1, i)) && e.getClientRects().length && (o = "border-box" === w.css(e, "boxSizing", !1, i),
        (r = s in e) && (a = e[s])),
    ...
    w.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var o, r, a, s = Y(t), l = Ye.test(t), c = e.style;
                if (l || (t = Be(s)),
    ...
    w.each(["height", "width"], (function(e, t) {
        w.cssHooks[t] = {
            get: function(e, n, i) {
                if (n)
                    return !Xe.test(w.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Ge(e, t, i) : Re(e, Ve, (function() {
                        return Ge(e, t, i)
                    }
                    ))
            },
            set: function(e, n, i) {
                var o, r = Pe(e), a = !h.scrollboxSize() && "absolute" === r.position, s = (a || i) && "border-box" === w.css(e, "boxSizing", !1, r), l = i ? Ke(e, t, i, s, r) : 0;
                return s && a && (l -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(r[t]) - Ke(e, t, "border", !1, r) - .5)),
    ...
    w.cssHooks.marginLeft = Fe(h.reliableMarginLeft, (function(e, t) {
        if (t)
            return (parseFloat(qe(e, "marginLeft")) || e.getBoundingClientRect().left - Re(e, {
                marginLeft: 0
            }, (function() {
    ...
    w.Animation = w.extend(ct, {
        ...
        prefilters: [function(e, t, n) {
            var i, o, r, a, s, l, c, u, p = "width"in t || "height"in t, f = this, h = {}, d = e.style, g = e.nodeType && ae(e), m = Q.get(e, "fxshow");
    ...
    w.extend(w.event, {
        trigger: function(t, n, i, o) {
            var r, a, s, l, c, p, f, h, y = [i || m], v = u.call(t, "type") ? t.type : t, b = u.call(t, "namespace") ? t.namespace.split(".") : [];
            if (a = h = s = i = i || m,
            ...
            o || !f.trigger || !1 !== f.trigger.apply(i, n))) {
                ...
                for (r = 0; (a = y[r++]) && !t.isPropagationStopped(); )
                    ...
                    (p = c && a[c]) && p.apply && V(a) && (t.result = p.apply(a, n),
                    !1 === t.result && t.preventDefault());
                return t.type = v,
                o || t.isDefaultPrevented() || f._default && !1 !== f._default.apply(y.pop(), n) || !V(i) || c && d(i[v]) && !g(i) && ((s = i[c]) && (i[c] = null),
                w.event.triggered = v,
    ...
    w.extend({
        ...
        ajax: function(t, n) {
            ...
            t = void 0),
            n = n || {};
            var i, o, r, a, s, l, c, u, p, f, h = w.ajaxSetup({}, n), d = h.context || h, g = h.context && (d.nodeType || d.jquery) ? w(d) : w.event, y = w.Deferred(), v = w.Callbacks("once memory"), b = h.statusCode || {}, x = {}, _ = {}, k = "canceled", E = {
                readyState: 0,
            ...
            o = h.url.replace(Lt, ""),
            h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(At, "+")) : (f = h.url.slice(o.length),
            h.data && (h.processData || "string" == typeof h.data) && (o += (_t.test(o) ? "&" : "?") + h.data,
            delete h.data),
            !1 === h.cache && (o = o.replace(Ot, "$1"),
            f = (_t.test(o) ? "&" : "?") + "_=" + wt.guid++ + f),
            h.url = o + f),
            ...
            if (h.beforeSend && (!1 === h.beforeSend.call(d, E, h) || c))
                return E.abort();
            if (k = "abort",
            v.add(h.complete),
            E.done(h.success),
            ...
            function T(t, n, a, l) {
                ...
                p ? (h.ifModified && ((_ = E.getResponseHeader("Last-Modified")) && (w.lastModified[o] = _),
                ...
                send: function(o, r) {
                    ...
                    n = function(e) {
                        return function() {
                            ...
                            "abort" === e ? s.abort() : "error" === e ? "number" != typeof s.status ? r(0, "error") : r(s.status, s.statusText) : r(Wt[s.status] || s.status, s.statusText, "text" !== (s.responseType || "text") || "string" != typeof s.responseText ? {
                                binary: s.response
                            } : {
                                text: s.responseText
...
function(e, t) {
    ...
    function m(e, n) {
        ...
        return (a && !o ? n.contains(p) : n === p && "BODY" !== p.nodeName) && (y = u(y, n)),
        y
    }
    function y(e) {
    ...
    function A(t, n, i) {
        return (void 0 === i ? t : t.slice(0, function(e, t, n) {
            ...
            t.enabled && e(i) && (n.offsets.popper = d(n.offsets.popper),
    ...
    function I(e, t, n, o) {
        ...
        var r = i(e);
        return D(r, "scroll", n.updateBound, n.scrollParents),
        n.scrollElement = r,
        n.eventsEnabled = !0,
        n
    }
    ...
    function R() {
        ...
        this.state = function(e, t) {
            return j(e).removeEventListener("resize", t.updateBound),
        ...
        modifiers: {
                ...
                fn: function(e, t) {
                    ...
                    var u = t.priority
                      ...
                      , f = {
                        primary: function(e) {
                            var n = p[e];
                            return p[e] < c[e] && !t.escapeWithReference && (n = Y(p[e], c[e])),
                            ee({}, e, n)
                        },
                        secondary: function(e) {
                            var n = "right" === e ? "left" : "top"
                              , i = p[n];
                            return p[e] > c[e] && !t.escapeWithReference && (i = U(p[n], c[e] - ("right" === e ? p.width : p.height))),
                            ee({}, n, i)
                        }
                    };
            ...
            arrow: {
                ...
                fn: function(e, n) {
                    ...
                    return w = Y(U(s[u] - m, w), 0),
                    e.arrowElement = o,
                    e.offsets.arrow = (ee(i = {}, f, X(w)),
                    ee(i, h, ""),
                    i),
                    e
                },
            ...
            computeStyle: {
                ...
                fn: function(e, t) {
                    ...
                    var s, l, c = void 0 === r ? t.gpuAcceleration : r, u = a(e.instance.popper), p = g(u), f = {
                        position: o.position
                    }, h = function(e, t) {
                        var n = e.offsets
                          , i = n.popper
                    ...
                    }(e, 2 > window.devicePixelRatio || !ne), d = "bottom" === n ? "top" : "bottom", m = "right" === i ? "left" : "right", y = N("transform");
                    if (l = "bottom" == d ? "HTML" === u.nodeName ? -u.clientHeight + h.bottom : -p.height + h.bottom : h.top,
                    s = "right" == m ? "HTML" === u.nodeName ? -u.clientWidth + h.right : -p.width + h.right : h.left,
                    c && y)
                        f[y] = "translate3d(" + s + "px, " + l + "px, 0)",
                        f[d] = 0,
                        f[m] = 0,
                    ...
                    return e.attributes = te({}, x, e.attributes),
...
function(e, t) {
    ...
    o.default(document).on("click.bs.button.data-api", '[data-toggle^="button"]', (function(e) {
        var t = e.target
          , n = t;
        if (o.default(t).hasClass("btn") || (t = o.default(t).closest(".btn")[0]),
    ...
    var g = "carousel"
      ...
      , x = function() {
        ...
        t._slide = function(e, t) {
            var n, i, r, a = this, s = this._element.querySelector(".active.carousel-item"), l = this._getItemIndex(s), u = t || s && this._getItemByDirection(e, s), p = this._getItemIndex(u), f = Boolean(this._interval);
            if ("next" === e ? (n = "carousel-item-left",
    ...
    var w = "collapse"
      ...
      , T = function() {
        ...
        ,
        t._getConfig = function(e) {
            return (e = l({}, k, e)).toggle = Boolean(e.toggle),
            c.typeCheckConfig(w, e, E),
            e
        }
        ,
        ...
        t._getParent = function() {
            var t, n = this;
            c.isElement(this._config.parent) ? (t = this._config.parent,
      ...
      , N = function() {
            ...
            !(this._element.disabled || o.default(this._element).hasClass("disabled") || o.default(this._menu).hasClass("show"))) {
                ...
                !i.isDefaultPrevented()) {
                    if (!this._inNavbar && t) {
                        ...
                        var s = this._element;
                        "parent" === this._config.reference ? s = a : c.isElement(this._config.reference) && (s = this._config.reference,
        ...
        t._getPlacement = function() {
            var e = o.default(this._element.parentNode)
              , t = "bottom-start";
            return e.hasClass("dropup") ? t = o.default(this._menu).hasClass("dropdown-menu-right") ? "top-end" : "top-start" : e.hasClass("dropright") ? t = "right-start" : e.hasClass("dropleft") ? t = "left-start" : o.default(this._menu).hasClass("dropdown-menu-right") && (t = "bottom-end"),
            t
        }
        ,
            ...
            if (!(/input|textarea/i.test(t.target.tagName) ? 32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || o.default(t.target).closest(".dropdown-menu").length) : !A.test(t.which)) && !this.disabled && !o.default(this).hasClass("disabled")) {
                ...
                if (i || 27 !== t.which) {
                    ...
                    !i || 27 === t.which || 32 === t.which)
                        return 27 === t.which && o.default(n.querySelector('[data-toggle="dropdown"]')).trigger("focus"),
    ...
    o.default(document).on("keydown.bs.dropdown.data-api", '[data-toggle="dropdown"]', N._dataApiKeydownHandler).on("keydown.bs.dropdown.data-api", ".dropdown-menu", N._dataApiKeydownHandler).on("click.bs.dropdown.data-api keyup.bs.dropdown.data-api", N._clearMenus).on("click.bs.dropdown.data-api", '[data-toggle="dropdown"]', (function(e) {
        e.preventDefault(),
        e.stopPropagation(),
        N._jQueryInterface.call(o.default(this), "toggle")
    }
        ...
        t._triggerBackdropTransition = function() {
            ...
            !t.isDefaultPrevented()) {
                ...
                o.default(this._element).one(c.TRANSITION_END, (function() {
                    ...
                    n || o.default(e._element).one(c.TRANSITION_END, (function() {
    ...
    var F = "tooltip"
      ...
      , $ = function() {
        ...
        t.setElementContent = function(e, t) {
            "object" != typeof t || !t.nodeType && !t.jquery ? this.config.html ? (this.config.sanitize && (t = q(t, this.config.whiteList, this.config.sanitizeFn)),
        ...
        t._enter = function(e, t) {
            ...
            o.default(t.getTipElement()).hasClass("show") || "show" === t._hoverState ? t._hoverState = "show" : (clearTimeout(t._timeout),
            t._hoverState = "show",
        ...
        t._fixTransition = function() {
            ...
            null === e.getAttribute("x-placement") && (o.default(e).removeClass("fade"),
      ...
      , te = function(e) {
        ...
        i._jQueryInterface = function(e) {
            return this.each((function() {
                ...
                o.default(this).data("bs.popover", t)),
                "string" == typeof e)) {
                    if (void 0 === t[e])
      ...
      , le = function() {
        ...
        return t.show = function() {
            ...
            if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && o.default(this._element).hasClass("active") || o.default(this._element).hasClass("disabled"))) {
                var t, n, i = o.default(this._element).closest(".nav, .list-group")[0], r = c.getSelectorFromElement(this._element);
                if (i) {
        ...
        t._transitionComplete = function(e, t, n) {
            ...
            if (o.default(e).addClass("active"),
    ...
    var ce = o.default.fn.toast
      ...
      , fe = function() {
        ...
        ,
        t._getConfig = function(e) {
            return e = l({}, pe, o.default(this._element).data(), "object" == typeof e && e ? e : {}),
...
function(e, t) {
    ...
    function g(e) {
        ...
        i.contains(e.scrollbarXRail) || (s(i, x.element.rail("x")).forEach((function(e) {
            return a(e)
        }
        )),
        i.appendChild(e.scrollbarXRail)),
        i.contains(e.scrollbarYRail) || (s(i, x.element.rail("y")).forEach((function(e) {
            return a(e)
        }
        )),
        ...
        e.scrollbarXLeft = h((e.negativeScrollAdjustment + i.scrollLeft) * (e.railXWidth - e.scrollbarXWidth) / (e.contentWidth - e.containerWidth))) : e.scrollbarXActive = !1,
        ...
        e.scrollbarYTop = h(o * (e.railYHeight - e.scrollbarYHeight) / (e.contentHeight - e.containerHeight))) : e.scrollbarYActive = !1,
    ...
    var T = {
      ...
      , S = {
        ...
        keyboard: function(e) {
            ...
            e.event.bind(e.ownerDocument, "keydown", (function(r) {
                if (!(r.isDefaultPrevented && r.isDefaultPrevented() || r.defaultPrevented) && (i() || o())) {
                    ...
                    e.settings.suppressScrollX && 0 !== s || e.settings.suppressScrollY && 0 !== l || (n.scrollTop -= l,
                    n.scrollLeft += s,
                    g(e),
                    function(i, o) {
                        var r = t(n.scrollTop);
        ...
        wheel: function(i) {
            function o(e, t, i) {
                if (!T.isWebKit && a.querySelector("select:focus"))
                    return !0;
                if (!a.contains(e))
                    return !1;
                for (var o = e; o && o !== a; ) {
            ...
            function r(n) {
                ...
                if (!o(n.target, s, l)) {
                    var c = !1;
                    i.settings.useBothWheelAxes ? i.scrollbarYActive && !i.scrollbarXActive ? (l ? a.scrollTop -= l * i.settings.wheelSpeed : a.scrollTop += s * i.settings.wheelSpeed,
                    c = !0) : i.scrollbarXActive && !i.scrollbarYActive && (s ? a.scrollLeft += s * i.settings.wheelSpeed : a.scrollLeft -= l * i.settings.wheelSpeed,
                    c = !0) : (a.scrollTop -= l * i.settings.wheelSpeed,
                    a.scrollLeft += s * i.settings.wheelSpeed),
                    g(i),
                    (c = c || function(n, o) {
                        var r = t(a.scrollTop)
                          , s = 0 === a.scrollTop
                    ...
                    }(s, l)) && !n.ctrlKey && (n.stopPropagation(),
                    n.preventDefault())
                }
            }
            var a = i.element;
        ...
        touch: function(i) {
            function o(n, o) {
                ...
                } else if (s > l && (0 > n && a === i.contentWidth - i.containerWidth || 0 < n && 0 === a))
                    return !0;
                return !0
            }
            function r(e, t) {
            ...
            function c(e, t, i) {
                ...
                for (var o = e; o && o !== f; ) {
                    ...
                    if (t && r.overflowX.match(/(scroll|auto)/)) {
                        ...
                        if (0 < s && (0 < o.scrollLeft && 0 > t || o.scrollLeft < s && 0 < t))
                            return !0
                    }
                    o = o.parentNode
                }
            ...
            if (T.supportsTouch || T.supportsIePointer) {
                var f = i.element
                  ...
                  , m = {}
                  , y = null;
                T.supportsTouch ? (i.event.bind(f, "touchstart", l),
                i.event.bind(f, "touchmove", u),
                i.event.bind(f, "touchend", p)) : T.supportsIePointer && (window.PointerEvent ? (i.event.bind(f, "pointerdown", l),
                i.event.bind(f, "pointermove", u),
                i.event.bind(f, "pointerup", p)) : window.MSPointerEvent && (i.event.bind(f, "MSPointerDown", l),
      ...
      , C = function(e, r) {
        ...
        this.scrollbarYLeft = h(p.left)) : this.isScrollbarYUsingRight = !0,
...
function(e, t, n, i) {
    ...
    function P(e, t) {
        ...
        for (o = 0; o < a.length; )
            ...
            t & (we | _e) && delete i[a[o].identifier],
            o++;
    ...
    var ie, oe = ["", "webkit", "Moz", "MS", "ms", "o"], re = t.createElement("div"), ae = "function", se = Math.round, le = Math.abs, ce = Date.now;
    ...
    e.MSPointerEvent && !e.PointerEvent && (He = "MSPointerDown",
    ...
    z.prototype = {
        ...
        recognize: function(e) {
            var t = ie({}, e);
            return u(this.options.enable, [this, t]) ? (this.state & (at | st | lt) && (this.state = nt),
    ...
    l(V, Y, {
        ...
        directionTest: function(e) {
            ...
            n = r != this.pX,
            i = Math.abs(e.deltaX)) : (o = 0 === a ? ke : 0 > a ? Se : Ce,
            n = a != this.pY,
            i = Math.abs(e.deltaY))),
            e.direction = o,
    ...
    l(Q, z, {
        ...
        emit: function(e) {
            this.state === at && (e && e.eventType & we ? this.manager.emit(this.options.event + "up", e) : (this._input.timeStamp = ce(),
    ...
    l(G, Y, {
        ...
        attrTest: function(e) {
            ...
            return n & (Ae | Le) ? t = e.overallVelocity : n & Ae ? t = e.overallVelocityX : n & Le && (t = e.overallVelocityY),
...
Unison = function() {
    ...
    return t.onresize = a.debounce(l.update, 100),
...
function() {
    ...
    function e(e) {
            ...
            if (!(i = e.extend({}, e.blockUI.defaults, i || {})).ignoreIfBlocked || !e(t).data("blockUI.isBlocked")) {
                ...
                i.fadeIn) {
                    var N = i.onBlock ? i.onBlock : l
                      ...
                      , j = m ? N : l;
                    i.showOverlay && x._fadeIn(i.fadeIn, M),
                    m && w._fadeIn(i.fadeIn, j)
                } else
                ...
                if (o(1, t, i),
                g ? (f = w[0],
                h = e(i.focusableElements, f),
                i.focusInput && setTimeout(a, 20)) : function(e, t, n) {
                    var i = e.parentNode
                      , o = e.style
        ...
        function o(t, n, i) {
            var o = n == window
              , a = e(n);
            if ((t || (!o || f) && (o || a.data("blockUI.isBlocked"))) && (a.data("blockUI.isBlocked", t),
        ...
        function r(t) {
            ...
            var r = t.data
              , s = e(t.target);
            return s.hasClass("blockOverlay") && r.onOverlayClick && r.onOverlayClick(t),
...
function() {
    ...
    var t, n, i, o, r, a, s, l, c, u, p, f, h, d, g, m, y, v, b, x, w, _, k, E, T, S, C, A, L, O, N, M, j, D, I, P, R, H, q, F, W, z, U, B, X, Y, V = [].slice, $ = {}.hasOwnProperty, Q = function(e, t) {
        for (var n in t)
            $.call(t, n) && (e[n] = t[n]);
        function i() {
            this.constructor = e
    ...
    G.prototype.trigger = function() {
        var e, t, n, i, o, r, a = arguments[0], s = 2 <= arguments.length ? V.call(arguments, 1) : [];
        if (null != (i = this.bindings) && i[a]) {
            for (n = 0,
            r = []; n < this.bindings[a].length; )
    ...
    F = 0,
    z = (B = ["ajax", "document", "eventLag", "elements"]).length; F < z; F++)
        !0 === C[D = B[F]] && (C[D] = v[D]);
    function J() {
    ...
    j = function(e) {
        ...
        if (!E.length && C.ajax) {
            if ("socket" === e && C.ajax.trackWebSockets)
                return !0;
            if (e = e.toUpperCase(),
            0 <= K.call(C.ajax.trackMethods, e))
                return !0
        }
        return !1
    }
    ...
    (_ = function() {
        ...
        if (!M(r))
            return a.running || !1 === C.restartOnRequestAfter && "force" !== j(i) ? void 0 : (n = arguments,
    ...
    p = function(e, t) {
        ...
        null != window.ProgressEvent)
            ...
            e.onreadystatechange = function() {
                var n;
                return 0 === (n = e.readyState) || 4 === n ? (t(a),
                a.progress = 100) : 3 === e.readyState && (a.progress = 50),
    ...
    ae.prototype.tick = function(e, t) {
        return 100 <= (t = null == t ? L(this.source, "progress") : t) && (this.done = !0),
    ...
    (T = function() {
        ...
        for (a.sources = I = [],
        t = 0,
        o = (s = ["ajax", "elements", "document", "eventLag"]).length; t < o; t++)
            !1 !== C[e = s[t]] && I.push(new l[e](C[e]));
        for (i = 0,
        r = (p = null != (u = C.extraSources) ? u : []).length; i < r; i++)
            D = p[i],
            I.push(new D(C));
        return a.bar = g = new n,
        N = [],
        P = new c
    }
    )(),
    a.stop = function() {
        return a.trigger("stop"),
        a.running = !1,
        g.destroy(),
        m = !0,
        null != h && ("function" == typeof y && y(h),
        h = null),
        T()
    }
    ,
    a.restart = function() {
        return a.trigger("restart"),
        a.stop(),
        a.start()
    }
    ,
    a.go = function() {
        ...
        h = O((function(t, n) {
            ...
            for (var i, o, r, s, l, u, p, f, h, d, y = u = 0, v = !0, b = p = 0, x = I.length; p < x; b = ++p)
                ...
                l = null != N[b] ? N[b] : N[b] = [],
                r = f = 0,
                h = (o = null != (d = D.elements) ? d : [D]).length; f < h; r = ++f)
                    s = o[r],
                    v &= (s = null != l[r] ? l[r] : l[r] = new c(s)).done,
                    s.done || (y++,
                    u += s.tick(t));
            return i = u / y,
            g.update(P.tick(t, i)),
    ...
    a.start = function(e) {
        ...
        return document.querySelector(".pace") ? (a.trigger("start"),
        a.go()) : setTimeout(a.start, 50)
    }
    ,
    "function" == typeof define && define.amd ? define((function() {
        return a
...
function(e, t) {
    ...
    function a(e) {
        var t, n, i, o = {
            top: 0,
            left: 0
        }, r = e && e.ownerDocument, a = r.documentElement;
    ...
    function f(e) {
        ...
        if (null !== s) {
            if (s.disabled || s.getAttribute("disabled") || s.classList.contains("disabled"))
                return;
            p.registerEvent(e),
            ...
            i && (s.addEventListener("touchend", l.hide, !1),
            s.addEventListener("touchcancel", l.hide, !1)),
        ...
        r(o, [{
            ...
            value: function(t, i, o) {
                ...
                if (x && g && "string" != typeof g && "boolean" != typeof g && "number" != typeof g && ["[object Number]", "[object Function]", "[object RegExp]"].indexOf(v) < 0 && ("string" != typeof b || "[object Array]" !== v)) {
                    ...
                    if (C || S || L) {
                        if (this.logger.log(L ? "updateKey" : "missingKey", p, u, l, L ? i.defaultValue : g),
                        a) {
                        ...
                        if ("fallback" === this.options.saveMissingTo && M && M[0])
                            ...
                            "all" === this.options.saveMissingTo ? N = this.languageUtils.toResolveHierarchy(i.lng || this.language) : N.push(i.lng || this.language);
                        var D = function(e, t) {
                            r.options.missingKeyHandler ? r.options.missingKeyHandler(e, u, t, L ? i.defaultValue : g, L, i) : r.backendConnector && r.backendConnector.saveMissing && r.backendConnector.saveMissing(e, u, t, L ? i.defaultValue : g, L, i),
                ...
                if (this.i18nFormat && this.i18nFormat.parse)
                    ...
                    !1 !== i.nest && (e = this.interpolator.nest(e, (function() {
                        for (var e = arguments.length, n = new Array(e), i = 0; i < e; i++)
                            n[i] = arguments[i];
                        return r && r[0] === n[0] ? (a.logger.warn("It seems you are nesting recursively key: ".concat(n[0], " in key: ").concat(t[0])),
                ...
                e.forEach((function(e) {
                    if (!a.isValidLookup(t)) {
                        ...
                        u.forEach((function(e) {
                            ...
                            !S["".concat(h[0], "-").concat(e)] && a.utils && a.utils.hasLoadedNamespace && !a.utils.hasLoadedNamespace(r) && (S["".concat(h[0], "-").concat(e)] = !0,
                            ...
                            h.forEach((function(n) {
                                if (!a.isValidLookup(t)) {
                                    o = n;
                                    var r, l, u = c, h = [u];
                                    for (a.i18nFormat && a.i18nFormat.addLookupKeys ? a.i18nFormat.addLookupKeys(h, c, n, e, s) : (p && (r = a.pluralResolver.getSuffix(n, s.count)),
                                    p && f && h.push(u + r),
                                    f && h.push(u += "".concat(a.options.contextSeparator).concat(s.context)),
                                    p && h.push(u += r)); l = h.pop(); )
    ...
    var L = function() {
      ...
      , j = function() {
        ...
        return r(e, [{
            ...
            key: "interpolate",
            value: function(e, t, n, i) {
                var o, r, a, s = this, l = this.options && this.options.interpolation && this.options.interpolation.defaultVariables || {};
                function c(e) {
                    return e.replace(/\$/g, "$$$$")
                }
                var u = function(e) {
                ...
                return [{
                    ...
                    for (a = 0; o = t.regex.exec(e); ) {
                        if (void 0 === (r = u(o[1].trim())))
                            ...
                            "string" == typeof r || s.useRawValueToEscape || (r = g(r));
            ...
            value: function(e, t) {
                ...
                delete s.defaultValue; i = this.nestingRegexp.exec(e); ) {
                    ...
                    if ((o = t(l.call(this, i[1].trim(), s), s)) && i[0] === e && "string" != typeof o)
                        return o;
    ...
    return {
        init: function(n, i) {
            ...
            function a(e) {
                return this.each((function() {
                    r(i(this), e),
                    i(this).find("[" + s.selectorAttr + "]").each((function() {
                        r(i(this), e)
                    }
                    ))
                }
  ...
  */
    ...
    , function(e, t, n) {
        var i = n(0)
          ...
          , c = n(65);
        e.exports = function(e, t) {
            var n, u, p, f, h, d = e.target, g = e.global, m = e.stat;
    ...
    , function(e, t, n) {
        ...
        var i = n(53)
          ...
          , c = n(48);
        e.exports = function(e) {
            var t, n, u, p, f = o(e), h = "function" == typeof this ? this : Array, d = arguments.length, g = d > 1 ? arguments[1] : void 0, m = void 0 !== g, y = 0, v = c(f);
            if (m && (g = i(g, d > 2 ? arguments[2] : void 0, 2)),
            null == v || h == Array && a(v))
                for (n = new h(t = s(f.length)); t > y; y++)
                    l(n, y, m ? g(f[y], y) : f[y]);
            else
                for (p = v.call(f),
                n = new h; !(u = p.next()).done; y++)
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e, t, n, u, h, v, b) {
            ...
            }, E = t + " Iterator", T = !1, S = e.prototype, C = S[m] || S["@@iterator"] || h && S[h], A = !g && C || k(h), L = "Array" == t && S.entries || C;
            if (L && (x = r(L.call(new e)),
            d !== Object.prototype && x.next && (p || r(x) === d || (a ? a(x, d) : "function" != typeof x[m] && l(x, m, y)),
            s(x, E, !0, !0),
            p && (f[E] = y))),
            "values" == h && C && "values" !== C.name && (T = !0,
            A = function() {
                return C.call(this)
            }
            ),
...
function(e) {
    ...
    e.fn.TouchSpin = function(n) {
        ...
        return this.each((function() {
            var r, a, s, l, c, u, p, f, h, d, g = e(this), m = g.data(), y = 0, v = !1;
            function b() {
                "" === r.prefix && (a = c.prefix.detach()),
                "" === r.postfix && (s = c.postfix.detach())
            }
            function x() {
                var e, t, n;
                ...
                if (!g.data("alreadyinitialized"))
                    ...
                    function() {
                        ...
                        n.hasClass("input-group") ? function(t) {
                            ...
                            e(n).insertBefore(g)),
                            a.hasClass("input-group-btn") || a.hasClass("input-group-append") ? (i = '<button class="' + r.buttonup_class + ' bootstrap-touchspin-up bootstrap-touchspin-injected" type="button">' + r.buttonup_txt + "</button>",
                            a.prepend(i)) : (i = '<span class="input-group-btn input-group-append bootstrap-touchspin-injected"><button class="' + r.buttonup_class + ' bootstrap-touchspin-up" type="button">' + r.buttonup_txt + "</button></span>",
                            e(i).insertAfter(g)),
                            e(s).insertBefore(g),
                            e(c).insertAfter(g),
                            l = t
                            ...
                            t = r.verticalbuttons ? '<div class="input-group ' + n + ' bootstrap-touchspin bootstrap-touchspin-injected"><span class="input-group-addon input-group-prepend bootstrap-touchspin-prefix"><span class="input-group-text">' + r.prefix + '</span></span><span class="input-group-addon bootstrap-touchspin-postfix input-group-append"><span class="input-group-text">' + r.postfix + '</span></span><span class="input-group-btn-vertical"><button class="' + r.buttondown_class + " bootstrap-touchspin-up " + r.verticalupclass + '" type="button">' + r.verticalup + '</button><button class="' + r.buttonup_class + " bootstrap-touchspin-down " + r.verticaldownclass + '" type="button">' + r.verticaldown + "</button></span></div>" : '<div class="input-group bootstrap-touchspin bootstrap-touchspin-injected"><span class="input-group-btn input-group-prepend"><button class="' + r.buttondown_class + ' bootstrap-touchspin-down" type="button">' + r.buttondown_txt + '</button></span><span class="input-group-addon bootstrap-touchspin-prefix input-group-prepend"><span class="input-group-text">' + r.prefix + '</span></span><span class="input-group-addon bootstrap-touchspin-postfix input-group-append"><span class="input-group-text">' + r.postfix + '</span></span><span class="input-group-btn input-group-append"><button class="' + r.buttonup_class + ' bootstrap-touchspin-up" type="button">' + r.buttonup_txt + "</button></span></div>",
                    ...
                    g.on("touchspin.updatesettings", (function(t, n) {
                        !function(t) {
                            (function(t) {
                                r = e.extend({}, r, t),
                                t.postfix && (0 === g.parent().find(".bootstrap-touchspin-postfix").length && s.insertAfter(g),
                                g.parent().find(".bootstrap-touchspin-postfix .input-group-text").text(t.postfix)),
                                t.prefix && (0 === g.parent().find(".bootstrap-touchspin-prefix").length && a.insertBefore(g),
