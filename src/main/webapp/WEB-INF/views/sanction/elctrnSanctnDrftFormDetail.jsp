                        ...
                        <div class="container">
                            ...
                            <div class="row" id="basic-table" style="background-color: white;">
                                <div class="col-12" style="margin-top: 10px;">
                                    ...
                                    <h1 class="font-large-2 fw-bolder mt-2 mb-0" id="content"
...
//                 console.log("c-name(" + index + ") : " + $(this).prop("id"));
        ...
        const handler = {
            init() {
                fileInput.addEventListener('change', () => {
                    ...
                    files.forEach(file => {
                        preview.innerHTML += "<p style='margin: 0px;' id='" + file.lastModified + "'>" +
        ...
        // 상신
        const formNm = document.querySelector('#formNm').value
        ...
        $("#content").on("click",function(){
			var str = '<p>직원들의 친목도모를 위한 워크샵을 진행하려고 합니다.&nbsp;</p><p><br></p><p>1. 제목 : 개발팀 워크샵</p><p>2. 일정 : 2022.01.27(목요일) 09:00 ~ 17:00</p><p>3. 장소 : 동학사</p><p>4. 비고 : 개인 물품 구비</p><p><br></p><p>자세한 사항은 첨부파일 참조</p>'
			$("#basicInput5").val("개발팀 워크샵 계획(안)");
