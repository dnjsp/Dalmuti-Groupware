...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/resources/css/plugins/forms/form-file-uploader.min.css">
    <!-- END: Page CSS-->
            ...
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="content-body">
                        <div class="container">
                            <!-- Basic Tables start -->
                            <div class="row" id="basic-table" style="background-color: white;">
                                <div class="col-12" style="margin-top: 10px;">
                                    <div class="col-lg-6 col-12" style="padding-bottom: 15px;">
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            ...
                                            <button type="button" class="btn btn-outline-primary waves-effect"
                                                data-toggle="modal" data-target="#addsanctionLine">결재라인</button>
                                            <button type="button" class="btn btn-outline-primary waves-effect"
                                                id="retrieveDoc" style="color: grey;" disabled>회수</button>
                                            <button type="button" class="btn btn-outline-primary waves-effect"
                                                data-toggle="modal" data-target="#addCcLine" style="color: grey;" disabled>참조</button>
                                            <button type="button" class="btn btn-outline-primary waves-effect"
                                                id="reUploadDoc" style="color: grey;" disabled>재기안</button>
                                            <button type="button" class="btn btn-outline-primary waves-effect"
                                                id="signDoc" style="color: grey;" disabled>승인</button>
                                            <button type="button" class="btn btn-outline-primary waves-effect"
                                                id="returnDoc" style="color: grey;" disabled>반려</button>
                                            <button type="button" class="btn btn-outline-primary waves-effect"
                                                id="setDisplay" style="color: grey;" disabled>공람</button>
                                            <button type="button" class="btn btn-outline-primary waves-effect"
                                    ...
                                    <!-- 결재라인 / 참조자 시작 -->
                                    <div class="modal fade text-left" id="addsanctionLine" tabindex="-1" role="dialog"
                                                                            ...
                                                                            <div id="rightMenu"
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <button
                                                                                        ...
                                                                                        style="margin-right: 10px; float: right; padding: 13px; width: 120px;">결재자
                                                                                        삭제</button>
                                                                                </div>
                                                                                <br style="clear: both;">
                                                                            </div>
                                    ...
                                    <div class="card-body">
                                        <form id="uploadForm" action="/sanction/sanctnAdd" method="post"
                                            enctype="multipart/form-data">
                                            <input type="hidden" id="formNm" name="formNm" value="${formNm}">
                                            ...
                                            <div class="row" style="padding-left: 14px;">
                                                <div class="d-input">
                                                    <label class="form-label" for="basicInput1">문서번호</label> <input
                                                     ...
                                                     <input type=hidden id="drftFormSn" value="${vo.drftFormSn}"></input>
                                                     <input type=hidden id="snNumber" name="snNumber" value="${snNumber}"></input>
                                                </div>
                                                <div class="d-input">
                                                    <label class="form-label" for="basicInput2">기안일자</label> <input
                                                        type="text" class="form-control" id="basicInput2"
                                                        value='<c:set var="ymd" value="<%=new java.util.Date()%>" /><fmt:formatDate value="${ymd}" pattern="yyyy-MM-dd" />'
                                                        readonly>
                                                </div>
                                                <div class="d-input">
                                                    <label class="form-label" for="basicInput3">기안자</label> <input
                                                        type="text" class="form-control" id="basicInput3" name="empNm"
                                                        value="${map.EMP_NM}" readonly>
                                                </div>
                                                <div class="d-input">
                                                    <label class="form-label" for="basicInput4">기안부서</label> <input
                                                        type="text" class="form-control" id="basicInput4" name="deptNm"
                                                        value="${map.DEPT_NM}" readonly>
                                                </div>
                                            ...
                                            <div>
                                                ...
                                                <div id="blog-editor-wrapper">
                                                    <div id="blog-editor-container">
                                                        <textarea id="editor" rows="17" cols="134" name="docCn">${docCn}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-1 d-file" style="padding-left: 0px;">
                                                <label class="form-label" for="basicInput1"
                                                    style="display: block;">첨부파일</label> <input class="form-control"
                                                    type="file" id="file-input" name="uploadFiles" multiple
                                                    style="width: 922px;">
                                            </div>
                        ...
                        <div class="modal fade text-left modal-primary saveSuccess" id="primary" tabindex="-1"
                            role="dialog" aria-labelledby="myModalLabel140" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header" style="justify-content: center;">
                                        <h5 class="modal-title" id="myModalLabel140"
                                            style="text-align: center; center;font-size: 13px;">저장</h5>
                        ...
                        <div class="modal fade text-left modal-primary writeDocSj" id="primary" tabindex="-1"
                            role="dialog" aria-labelledby="myModalLabel140" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header" style="justify-content: center;">
                                        <h5 class="modal-title" id="myModalLabel140"
                                            style="text-align: center; center;font-size: 13px;">제목</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body" style="text-align: center;font-size: 15px;">
                                        문서 제목을 입력하여 주시기 바랍니다.
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="modal fade text-left modal-primary writeDocCn" id="primary" tabindex="-1"
                            role="dialog" aria-labelledby="myModalLabel140" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header" style="justify-content: center;">
                                        <h5 class="modal-title" id="myModalLabel140"
                                            style="text-align: center; center;font-size: 13px;">내용</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body" style="text-align: center;font-size: 15px;">
                                        문서 내용을 입력하여 주시기 바랍니다.
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="modal fade text-left modal-primary writeLine" id="primary" tabindex="-1"
                            role="dialog" aria-labelledby="myModalLabel140" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header" style="justify-content: center;">
                                        <h5 class="modal-title" id="myModalLabel140"
                                            style="text-align: center; center;font-size: 13px;">결재라인</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                        ...
                        <div class="modal fade text-left modal-primary maxLine" id="primary" tabindex="-1"
                            role="dialog" aria-labelledby="myModalLabel140" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header" style="justify-content: center;">
                        ...
                        <div class="modal fade text-left modal-primary uploadModal" id="returnPrvonsh" tabindex="-1"
                            role="dialog" aria-labelledby="myModalLabel140" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header" style="justify-content: center;">
                                        <h5 class="modal-title" id="myModalLabel140"
                                            style="text-align: center; center;font-size: 13px;">상신</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            <div class="d-flex justify-content-between">
                                                <label for="login-password"
                                                    style="text-align: center;">상신하시겠습니까?</label>
                                            </div>
                                        </div>
                        ...
                        <div class="modal fade text-left modal-primary closeModal" id="returnPrvonsh" tabindex="-1"
                            role="dialog" aria-labelledby="myModalLabel140" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header" style="justify-content: center;">
                                    ...
                                    <div class="modal-body" style="padding: 0rem 1.4rem 0.8rem 1.4rem;">
                                        <div class="form-group">
                                            <div class="d-flex justify-content-between">
                                                <label for="login-password" style="text-align: center;">창을
                                                    닫으시겠습니까?</label>
                                            </div>
                                        </div>
                                        <div class="modal-footer"
...
//                 console.log("sanctionSearch : " + $("#sanctionSearch")[0]);
...
//                         console.log(empNo + " : " + $(item).prop("id") + "=>존재함");
                ...
                if (flag == true) {
                    $("#appLineTable").append(
                        "<tr class='apptr'><td>" + empCount + "</td><td>" + deptNm + "</td><td class='clsfNm'>" +
                        clsfCode + "</td><td id='" + empNo + "' data-empNo='" + empNo + "' class='c-name'>" +
                        empNm + "</td></tr>"
                    );
                    empCount++;
                }
...
//                 console.log("c-name(" + index + ") : " + $(this).prop("id"));
        ...
        $(function () {
         var drftFormSn = document.getElementById('drftFormSn').value;
         const div = document.getElementById('docCnTable');
         if(drftFormSn == 1){
        	...
        	document.getElementById('basicInput5').readOnly=true;
         	document.getElementById('editor').setAttribute("style","display:none;");
        	document.getElementById('saveDoc').disabled=true;
        }
        }) 
