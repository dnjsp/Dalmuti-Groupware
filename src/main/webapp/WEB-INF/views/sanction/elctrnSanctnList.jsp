                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12" style="padding-bottom: 15px; padding-top: 20px;">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#" style="cursor: default;">결재</a></li>
                                        ...
                                        <div id="tab-1" class="tab-content current">
                                            <div class="card" style="height: 560px;">
                                                <div class="card-header">
                                                    ...
                                                    <form action="/sanction/elctrnSanctnSearch?tab=${tab}"
                                                        ...
                                                        <div style="display:flex;">
                                                            <input type="hidden" id="ccAt" value="${tab}" />
                                                ...
                                                <div class="table-responsive">
                                                    <form action="/sanction/deleteCheckBoxReturn" method="post"
                                                                    ...
                                                                    <c:when test="${not empty mapList.content}">
                                                                        <c:forEach var="row" items="${mapList.content}"
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>${row.EMP_NM}</td>
                                                                                <c:if test="${dsplayAt eq 'yes'}">
                                                                                    <td>${row.DSPLAY_EMP_NM}</td>
                                                                                </c:if>
                                                                                <td>${row.DRFT_DE}</td>
                                                                                <td>${row.SANCTN_COMPT_DE}</td>
                                                                            </tr>
                                                                        </c:forEach>
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                        <tr>
                                                                            <td colspan="6" style="padding: 30px;">목록이
                                                                                없습니다.</td>
                                                                        </tr>
                                                                    </c:otherwise>
                                                                </c:choose>
                        ...
                        <div class="modal fade text-left modal-primary deleteModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal fade text-left modal-primary deleteCheck" tabindex="-1" role="dialog"
                            aria-labelledby="myModalLabel140" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header" style="justify-content: center;">
                                    ...
                                    <div class="modal-body" style="padding: 0rem 1.4rem 0.8rem 1.4rem;">
                                        <div class="form-group">
                                            <div class="d-flex justify-content-between">
                                                <label for="login-password" style="text-align: center;">삭제할 문서를 선택하여 주시기
                                                    바랍니다.</label>
                                            </div>
                                        </div>
                                        <div class="modal-footer"
                                                ...
                                                <li class="timeline-item">
                                                    ...
                                                    <div class="timeline-event">
                                                        <div
                                                            ...
                                                            <h6 style="padding-bottom: 15px; margin: 0px;">결재현황</h6>
                                                        </div>
                                                        <div
...
<script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    $.each(res, function (i, v) {
                        ...
                        if (v.SANCTN_STTUS_CODE == '반려') {
                            sttus +=
                                "<p class='mb-0' style='padding-bottom: 25px; color: red;'>" +
                                v.SANCTN_STTUS_CODE + "</p>"
                        } else {
    ...
    const deleteCheckBox = () => {
        ...
        if (checkedArray.length == 0) {
            ...
            confirm.addEventListener('click', function () {
                $.ajax({
                    url: '/sanction/deleteCheckBoxReturn',
                    type: 'POST',
                    traditional: true,
                    data: {
    ...
    // 참조문서를 클릭할 때 확인 여부 수정하기
    const ccAt = document.querySelector('#ccAt')
    if (ccAt.value == 'cc') {
        for (var i = 0; i < td_open.length; i++) {
            td_open[i].addEventListener('click', function (e) {
                var elctrnSanctnSn = e.target.getAttribute('data-value')
