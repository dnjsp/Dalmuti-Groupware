                        ...
                        <div class="col-12" style="padding-bottom: 10px;">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">휴가신청함
                                    </li>
                                </ol>
                            </div>
                        </div>
	                      	...
	                      	<div id="tab-1" class="tab-content current">
	                        	<div class="card" style="height: 570px;">
	                        		...
	                        		<div class="searchBsrp" style="padding-top: 10px; display: flex;">
	                        			<select class="form-control mb-1" id="searchFilter" name="searchType" style="width: 165px; height: 40px;">
	                            ...
	                            <div class="table-responsive">
	                                <table class="table" id="vcatnTable">
	                                    <thead>
	                                        <tr>
	                                        	<th style="width:1%;">
	                                        		<div class="custom-control custom-checkbox">
	                                        			<input id="allCheck" type="checkbox" class="custom-control-input" name="allCheck"/>
	                                    ...
	                                    <tbody>
	                                    <c:forEach var="v" items="${pagination.content}" varStatus="status">
	                                        <tr class="rowContent" style = "cursor:pointer;">
	                                        	<td>
	                                        		<div class="custom-control custom-checkbox">
	                                        			<input name="RowCheck" class="custom-control-input" type="checkbox" value="${v.VCATN_SN}" id="${v.VCATN_SN}-RowCheck">
	                                        			<label class="custom-control-label" for="${v.VCATN_SN}-RowCheck"></label>
	                                        		</div>
	                                        	</td>
	                                            <td class="vcatnContent" onclick = "location.href='/dclz/vcatnDetail?vcatnSn=' + ${v.VCATN_SN}">${status.count}</td>
	                                            <td class="vcatnContent" onclick = "location.href='/dclz/vcatnDetail?vcatnSn=' + ${v.VCATN_SN}">${v.REQSTDOC_SJ}</td>
	                                            <td class="vcatnContent" onclick = "location.href='/dclz/vcatnDetail?vcatnSn=' + ${v.VCATN_SN}">${v.BGN_DE} ~ ${v.END_DE}</td>
	                                            <td class="vcatnContent" onclick = "location.href='/dclz/vcatnDetail?vcatnSn=' + ${v.VCATN_SN}">${v.VCATN_SE_CODE}</td>
	                                            <td class="vcatnContent" onclick = "location.href='/dclz/vcatnDetail?vcatnSn=' + ${v.VCATN_SN}">${v.REQST_DE}</td>
	                                            <td class="vcatnContent" onclick = "location.href='/dclz/vcatnDetail?vcatnSn=' + ${v.VCATN_SN}">${v.sanctnStat}</td>
	                                        </tr>
	                                    </c:forEach>
	                                    </tbody>
	                                </table>
										...
										<div class="dataTables_paginate paging_simple_numbers"
											...
											<ul class="pagination">
												<li
													...
													href="/dclz/vcatnList?currentPage=${pagination.startPage - 5}"
												...
												<c:forEach var="page" begin="${pagination.startPage}"
													...
													<li
														...
														<a href="/dclz/vcatnList?currentPage=${page}"
   				...
   				success:function(result){
					...
					pageStr += '</ul></div>'
   					...
   					if(result.content.length){
   						...
   						thead += "<th style='text-align:center;'>구분</th>";
   						...
   						$.each(result.content, function(i,v){
							...
							tbody += "<td><div class='custom-control custom-checkbox'><input name='RowCheck' class='custom-control-input' id='" + v.VCATN_SN + "-RowCheck' type='checkbox' value="+v.VCATN_SN+"><label class='custom-control-label' for='" + v.VCATN_SN + "-RowCheck'></label></div></td>"
   							tbody += "<td style='text-align:center;width:98.83px;' onclick =location.href='vcatnDetail?vcatnSn=" + v.VCATN_SN +"'>" + v.RNUM + "</td>"
   							tbody += "<td style='text-align:center;width:288.42px;' onclick =location.href='vcatnDetail?vcatnSn=" + v.VCATN_SN +"'>" + v.REQSTDOC_SJ + "</td>"
   							tbody += "<td style='text-align:center;width:352.92px;' onclick =location.href='vcatnDetail?vcatnSn=" + v.VCATN_SN +"'>" + v.BGN_DE+" ~ "+ v.END_DE + "</td>" 
   							tbody += "<td style='text-align:center;width:165.91px;' onclick =location.href='vcatnDetail?vcatnSn=" + v.VCATN_SN +"'>" + v.VCATN_SE_CODE + "</td>"
   							tbody += "<td style='text-align:center;width:271px;' onclick =location.href='vcatnDetail?vcatnSn=" + v.VCATN_SN +"'>" + v.REQST_DE + "</td>"
   							tbody += "<td style='text-align:center;width:165.92px;'>" + v.sanctnStat + "</td>"
   							tbody += "</tr>"
