...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="">
    ...
    <div class="app-content content ">
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12" style="padding-bottom: 10px;">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#" style="cursor: default;">휴가관리</a></li>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <select id="se" class="form-control mb-1" name="vcatnSeCode" style="width:280px;" >
		...
		<div class="modal fade text-left modal-primary select" id="primary" tabindex="-1" role="dialog" aria-labelledby="myModalLabel140" aria-hidden="true">
				...
				<div class="modal fade text-left modal-primary countdayModal" id="primary" tabindex="-1" role="dialog" aria-labelledby="myModalLabel140" aria-hidden="true">
				    <div class="modal-dialog modal-dialog-centered" role="document">
				        <div class="modal-content">
				            <div class="modal-header" style="justify-content: center;">
				                <h5 class="modal-title" id="myModalLabel140" style="text-align: center; center;font-size: 13px;">신청일수</h5>
				                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
				                    <span aria-hidden="true">&times;</span>
				                </button>
				            </div>
				            <div class="modal-body" style="text-align: center;font-size: 15px;">
				                휴가신청 가능한 일수를 초과하였습니다.
				            </div>
				            <div class="modal-footer" style="justify-content: center;">
				                <button type="button" class="btn btn-primary" data-dismiss="modal" id="countdayConfirm">확인</button>
				            </div>
				        </div>
				    </div>
				</div>        
...
// 		}
        ...
        // 휴일을 제외한 날짜 수 계산 (주현)
        function calcDate() {
			var date1 = document.getElementById('bgnDay').value						
			var date2 = document.getElementById('endDay').value
			
			$.ajax({
				url : 'vcatnRequestCount',
				type : 'POST',
				data : {
					'startDate' : date1,
					'endDate' : date2
				...
				success : function(res) {
					var remndrDaycnt = document.querySelector('#remndrDaycnt').value
					var countday = res
					
					if (remndrDaycnt < countday) {
						$('.countdayModal').modal()
						document.querySelector('#countdayConfirm').addEventListener('click', function() {
							location.reload()
						})
					} else {
						document.querySelector('#countday').value = res
						document.querySelector('#countday').setAttribute('readonly', 'true')
					}
				}
			})
		}
		...
		function emptycheck() {
			  var form = $("#vcatnForm").serialize();
				$('#vcatnForm').find('input[type!="hidden"]'&&'textarea').each(function(){
					if(!$(this).val()){
						is_empty= true;
					}
				});
		 ...
		 $("#content").on("click",function(){
			  $("#se").val("V1");
// 			  $("#bgnDay").val("2022-01-25");
// 			  $("#endDay").val("2022-01-25");
// 			  $("#countday").val("1");
// 			  $("#countday").attr("readonly", true);
			  $("#reqstdocSj").val("${empVO.deptNm} ${empVO.empNm} 휴가신청서");
			  $("#bsrpCn").val("건강검진");
