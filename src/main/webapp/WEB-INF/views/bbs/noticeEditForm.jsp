            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
	                <a href="/bbs/noticeList?currentPage=1"><h2 class="content-header-title float-left mb-0">공지사항</h2></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form action="/bbs/noticeEditProcess" method="post" enctype ="multipart/form-data" class="mt-2" id="contentForm">
