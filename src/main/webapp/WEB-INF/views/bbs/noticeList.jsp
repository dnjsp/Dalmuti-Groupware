                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <div class="breadcrumb-wrapper">
                            	<a href="/bbs/noticeList"><h2 class="content-header-title float-left mb-0" style="margin-left: 70px;">공지사항</h2></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="content-body">
                ...
                <section id="basic-datatable">
					...
					<div class="noPaging" style="display:flex; justify-content: center;">
                          <div class="card" id="tabVerticalRight1" role="tabpanel" aria-labelledby="baseVerticalRight-tab1" style="display:flex;height:575px;width: 1300px;">
						...
						<div class="tab-content">
							<div class="tab-pane active">
								<table class="datatables-basic table" id="noticeTable">
									...
									<tr class="rowContent" onclick = "location.href='/bbs/noticeView?bbscttSn=' + ${row.BBSCTT_SN}" style = "cursor:pointer;">
                           ...
                           <div class="paging" style="display: flex;justify-content: center; width:1300px;">
                               <div class="card-body" style="display: flex;justify-content: center; padding:0px;margin-top: 10px;">
                                   <ul class="pagination firstLast1-links">
                                    <li class="page-item first"><a href="/bbs/noticeList?currentPage=1" class="page-link">First</a></li>
                                    <li class="page-item prev <c:if test="${list.startPage<=5}">disabled</c:if>">
                                    	<a href="/bbs/noticeList?currentPage=${list.startPage-5}" class="page-link">Prev</a>
                                    </li>
                                    <c:forEach var="page" begin="${list.startPage}" end="${list.endPage}">
                                    	<li class="page-item <c:if test='${param.currentPage eq page}'>active</c:if>">
                                    		<a href="/bbs/noticeList?currentPage=${page}" class="page-link">${page}</a>
                                    	</li>
                                    </c:forEach>
                                    <li class="page-item next <c:if test="${list.endPage>=list.totalPages}">disabled</c:if>">
                                    	<a href="/bbs/noticeList?currentPage=${list.startPage+5}" class="page-link">Next</a>
                                    </li>
                                    <li class="page-item last"><a href="/bbs/noticeList?currentPage=${list.totalPages}" class="page-link">Last</a></li>
                                   </ul>
                               </div>
                           </div>
					</div>
    ...
    <script>
        ...
        $(function(){
	    	 $("#noticeAdd").on("click", function(){
	    		 location.href = "/bbs/noticeWriteForm";
	    	 });
	     });
				...
				success:function(result){
					...
					if(result.content.length){
						$.each(result.content, function(i,v){
							tbody += "<tr class='rowContent' onclick = location.href='/bbs/noticeView?bbscttSn=" + v.BBSCTT_SN + "' style = 'cursor:pointer;'>"
