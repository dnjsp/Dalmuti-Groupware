...
<head>
   ...
   function replaceAdminCrtfList() {
   	  location.replace("adminCrtfList")
   }
        ...
        //event.stopPropergation(); // 이벤트 전파 막기
          ...
          $.ajax({
             ...
             success : function(crtfData) {
  			  ...
  			  var day2 = parseInt(diff/currDay);

  			  if(month >= 12) {
  				  month = (day2-(year*365))%30;
  			  }
        ...
        <div class="content-wrapper container-xxl p-0">
                        ...
                        <div class="col-12" style="padding-left: 75px; padding-bottom: 10px;">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">증명서 승인
                                    </li>
                                </ol>
                            </div>
                        </div>
            <div class="content-body">
                            ...
                            <div class="noPaging" style="display:flex; justify-content: center;">
                              <div class="card" style="width: 1300px;">
                                  ...
                                  <div class="card-body" style="padding: 0.8rem; width: 1300px; padding-bottom: 15px; padding-top: 15px;">
	                                  ...
	                                  <button type="button" class="btn btn-primary mr-1" onclick="confmValue();">증명서 승인</button>
	                                  <button type="button" class="btn btn-outline-primary waves-effect" onclick="returnValue();">증명서 반려 </button>
                                  	</div>
                                  </div>
                               
                               <div class="table-responsive" style="height:590px;width: 1300px; display:flex;">
                                   <table class="table" style="text-align: center;">
                                       <thead>
                                           <tr>
                                              <th style="width:1%;">
                                              	<div class="custom-control custom-checkbox">
                                              		<input class="custom-control-input" id="allCheck" type="checkbox" name="allCheck"/>
                                       ...
                                       <tbody>
                                       <c:forEach var="row" items="${adminCrtfList.content}" varStatus="status">
                                           <tr class="rowContent" style = "height: 53px;">
                                              <td>
                                              	<div class="custom-control custom-checkbox">
                                              		<input name="RowCheck" class="custom-control-input" type="checkbox" id="${row.CRTF_REQST_SN}-checkboxSn" value="${row.CRTF_REQST_SN}">
                                              		<label class="custom-control-label" for="${row.CRTF_REQST_SN}-checkboxSn"></label>
                                              	</div>
                                              </td>
                                               <td class="crtfContent">${row.CRTF_REQST_SN}</td>
                          ...
                          <div class="paging" style="display: flex;justify-content: center; width:1300px;">
                              <div class="card-body" style="display: flex;justify-content: center; padding:0px;margin-top: 10px;">
                                  <ul class="pagination firstLast1-links">
                                   <li class="page-item first"><a href="/hr/adminCrtfList?currentPage=1" class="page-link">First</a></li>
                                   <li class="page-item prev <c:if test="${adminCrtfList.startPage<=5}">disabled</c:if>">
                                   	<a href="/hr/adminCrtfList?currentPage=${adminCrtfList.startPage-5}" class="page-link">Prev</a>
                                   </li>
                                   <c:forEach var="page" begin="${adminCrtfList.startPage}" end="${adminCrtfList.endPage}">
                                   	<li class="page-item <c:if test='${param.currentPage eq page}'>active</c:if>">
                                   		<a href="/hr/adminCrtfList?currentPage=${page}" class="page-link">${page}</a>
                                   	</li>
                                   </c:forEach>
                                   <li class="page-item next <c:if test="${adminCrtfList.endPage>=adminCrtfList.totalPages}">disabled</c:if>">
                                   	<a href="/hr/adminCrtfList?currentPage=${adminCrtfList.startPage+5}" class="page-link">Next</a>
                                   </li>
                                   <li class="page-item last"><a href="/hr/adminCrtfList?currentPage=${adminCrtfList.endPage}" class="page-link">Last</a></li>
                                  </ul>
                              </div>
                          </div>
             </div>
              ...
              <!-- 선택된 증명서 신청이 없을 때 삭제안내 modal 끝 -->
				<!-- 증명서 승인 창 modal -->
                       <div class="modal fade text-left modal-primary crtfPass" id="primary" tabindex="-1" role="dialog" aria-labelledby="myModalLabel142" aria-hidden="true">
                      <div class="modal-dialog modal-dialog-centered" role="document">
                          <div class="modal-content">
                              <div class="modal-header" style="justify-content: center;">
                                  <h5 class="modal-title" id="myModalLabel142" style="text-align: center; center;font-size: 13px;">증명서 승인 안내</h5>
                              ...
                              <div class="modal-footer" style="justify-content: center;">
                                  <button type="button" class="btn btn-primary crtfOk" data-dismiss="modal" onclick="replaceAdminCrtfList()">확인</button>
                              </div>
                          </div>
                      </div>
                  </div>
