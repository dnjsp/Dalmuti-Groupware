...
<html class="loading dark-layout" lang="en" data-layout="dark-layout" data-textdirection="ltr">
  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="/resources/css/pages/page-misc.min.css">
    <!-- END: Page CSS-->
          ...
          <div class="misc-wrapper"><a class="brand-logo" href="javascript:void(0);">
            ...
            <div class="misc-inner p-2 p-sm-3">
              <div class="w-100 text-center">
                ...
                <p class="mb-2">Oops! 😖 The requested URL was not found on this server.</p><a class="btn btn-primary mb-2 btn-sm-block" href="index.html">Back to home</a><img class="img-fluid" src="/resources/images/pages/error-dark.svg" alt="Error page"/>
              </div>
            </div>
          </div>
          <!-- / Error page-->
