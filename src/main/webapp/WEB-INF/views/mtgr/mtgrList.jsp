...
<script type="text/javascript">
    ...
    function replaceMtgrList() {
          location.replace("mtgrList?currentPage=1");
     }
    </script>
</head>
<!-- END: Head-->
				...
				<div class="content-header-left col-md-9 col-12 mb-2">
					<div class="row breadcrumbs-top">
						<div class="col-12" style="padding-left: 75px; padding-bottom: 10px;">
							<h2 class="content-header-title float-left mb-0">예약</h2>
									...
									<div class="col-12" style="margin-top: 10px;">
										<div class="noPaging" style="display:flex; justify-content: center;">
                              				<div class="card" style="width: 1300px;">
                                  				...
                                  				<div class="card-body" style="padding: 0.8rem; width: 1300px;">
													<div class="basic-modal" style="padding: 5px;">
														<!-- Confirm option section -->
														<section id="confirm-option" style="display: flex; flex-direction: row-reverse; gap: 5px;">
															<c:if test="${isAuth}">
																<button type="button" class="btn btn-primary"
																	data-toggle="modal" data-target="#addMtgr">회의실 등록</button>
																<button type="button" class="btn btn-outline-primary" onclick="deleteValue();">삭제</button>
															</c:if>
														</section>
														<!--/ Confirm option section -->
												...
												<div class="table-responsive"
													 style="height:575px;width: 1300px;">
													<table class="table">
														<thead>
															<tr>
																<c:if test="${isAuth}">
															...
															<form class="form" id="mtgrInsert">
																<div class="modal-body">
																	...
																	<div class="form-group">
																		<input type="text" name="mtgrUnit" id="no"
																			placeholder="ex)301(o) 301호(x)" class="form-control" />
																	</div>

																	<label>회의실명 </label>
																	<div class="form-group">
																		<input type="text" name="mtgrNm" id="nm"
																			placeholder="ex)세미나실" class="form-control" />
																	</div>

																	<label>위치</label>
																	<div class="form-group">
																		<input type="text" name="mtgrLc" id="location"
																			placeholder="ex)3-301" class="form-control" />
																	</div>

																	<label>수용인원</label>
																	<div class="form-group">
																		<input type="text" name="aceptncNmpr" id="people"
												...
												<div class="modal fade text-left modal-primary insert"
													...
													<div class="modal-dialog modal-dialog-centered"
														...
														<div class="modal-content">
															...
															<div class="modal-body"
																style="text-align: center; font-size: 15px;">이미 등록된 회의실입니다.
															</div>
															<div class="modal-footer" style="justify-content: center;">
							                                   <button type="button" class="btn btn-primary crtfOk" data-dismiss="modal" 
							                                   onclick="replaceMtgrList()">확인</button>
							                                </div>	
														</div>
													</div>
												</div>
												...
												<div class="modal fade text-left modal-primary insertMtgr"
													...
													<div class="modal-dialog modal-dialog-centered"
														...
														<div class="modal-content">
															...
															<div class="modal-body" style="text-align: center; font-size: 15px;">등록 완료되었습니다.</div>
															<div class="modal-footer" style="justify-content: center;">
							                                   <button type="button" class="btn btn-primary crtfOk" data-dismiss="modal" 
							                                   onclick="replaceMtgrList()">확인</button>
							                                </div>	
												...
												<div class="modal fade text-left modal-primary mtgrChk"
													...
													<div class="modal-dialog modal-dialog-centered"
														...
														<div class="modal-content">
															...
															<div class="modal-body"
																style="text-align: center; font-size: 15px;">선택된 회의실이 없습니다.
															</div>
														</div>
													</div>
												</div>
												...
												<!-- 회의실 삭제 창 modal 끝 -->
												<!-- 회의실 삭제 창 modal -->
												<div class="modal fade text-left modal-primary mtgrDeleteImpass"
													id="primary" tabindex="-1" role="dialog"
													aria-labelledby="myModalLabel142" aria-hidden="true">
													<div class="modal-dialog modal-dialog-centered"
														role="document">
