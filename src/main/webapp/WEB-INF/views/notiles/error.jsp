                ...
                <div class="misc-wrapper"><a class="brand-logo" href="javascript:void(0);">
                    ...
                    <div class="misc-inner p-2 p-sm-3">
                        <div class="w-100 text-center">
                            ...
                            <p class="mb-2">페이지를 찾을 수 없습니다.</p><a class="btn btn-primary mb-2 btn-sm-block" href="/">메인으로 가기</a><img class="img-fluid" src="/resources/images/pages/error.svg" alt="Error page" />
                        </div>
                    </div>
                </div>
                <!-- / Error page-->
