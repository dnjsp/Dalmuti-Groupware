...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/resources/css/pages/page-auth.css">
    <!-- END: Page CSS-->
...
<body class="horizontal-layout horizontal-menu blank-page navbar-floating footer-static  " data-open="hover" data-menu="horizontal-menu" data-col="blank-page">
            ...
            <div class="content-body">
                <div class="auth-wrapper auth-v2">
                    <div class="auth-inner row m-0">
                        <!-- Brand logo--><a class="brand-logo" href="javascript:void(0);" style="cursor: default;">
                            ...
                            <h2 class="brand-text text-primary ml-1">SoftLab</h2>
                        </a>
                        <!-- /Brand logo-->
                        <!-- Left Text-->
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="/resources/images/pages/forgot-password-v2.svg" alt="Forgot password V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Forgot password-->
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h2 class="card-title font-weight-bold mb-1">비밀번호를 잊으셨나요? 🔒</h2>
                                <p class="card-text mb-2 successPhoneChk">휴대폰번호를 입력하시면 임시비밀번호를 보내드립니다.</p>
                                <form id="smsForm" class="auth-forgot-password-form mt-2" method="POST">
                                    <div class="form-group">
                                        <label class="form-label" for="forgot-password-email">휴대폰번호</label>
                                        <input id="phone"name="to" class="form-control" type="text" name="forgot-password-email" placeholder="01012345678" aria-describedby="forgot-password-email" tabindex="1" />
                                    </div>
                                    <span id="phoneChk" class="btn btn-primary btn-block" tabindex="2">전송</span>
                                </form>
                                <p class="text-center mt-2"><a href="/login"><i data-feather="chevron-left"></i> 로그인하기</a></p>
                            </div>
                        </div>
                        <!-- /Forgot password-->
                    </div>
    ...
    <!-- BEGIN: Page JS-->
    <script src="/resources/js/scripts/pages/page-auth-forgot-password.js"></script>
    <!-- END: Page JS-->
        	...
        	$.ajax({
				...
				success:function(data){
					if (data.result == "false") {
						$(".successPhoneChk").text("유효한 번호를 입력해 주세요.");
						$(".successPhoneChk").css("color","red");
						$("#phone").attr("autofocus",true);
					} else if(data.result =="true") {
						$(".successPhoneChk").text("임시 비밀번호 전송이 완료되었습니다.");
