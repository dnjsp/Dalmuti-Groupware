...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/resources/css/pages/page-misc.css">
    <!-- END: Page CSS-->
                ...
                <div class="misc-wrapper"><a class="brand-logo" href="javascript:void(0);">
                    ...
                    <div class="misc-inner p-2 p-sm-3">
                        <div class="w-100 text-center">
                           	<h2 class="mb-1">권한이 없습니다! 🔐</h2>
                            <p class="mb-2">
                                관리자에게 문의 바랍니다.
                            </p>
                            <a class="btn btn-primary mb-1 btn-sm-block" href="/">메인으로 가기</a>
                            <img class="img-fluid" src="/resources/images/pages/not-authorized.svg" alt="Not authorized page" />
                        </div>
                    </div>
                </div>
                <!-- / Not authorized-->
